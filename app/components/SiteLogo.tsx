...
export default function SiteLogo({ size = 44, className = '' }: SiteLogoProps) {
  return (
    <Link href="/" aria-label="University of Huddersfield AI with Decision Support Systems logo">
        <div
        ...
        <Image
            src="/images/logo.png"
            alt="University of Huddersfield AI with Decision Support Systems logo"
            fill
            sizes={`${size}px`}
