...
export default function About() {
  return (
    <section id="about" className="py-14 md:py-16 bg-[rgba(202,190,216,0.18)]">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-4">
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-4 text-[var(--ink)]">Focus areas</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex items-start gap-3">
                  <ChevronRight
                    aria-hidden="true"
                    className="mt-1 h-5 w-5 shrink-0 text-[var(--brand-strong)]"
                  />
                  <span className="text-[var(--muted)] text-lg">{item}</span>
                </li>
              ))}
            </ul>
          </div>
